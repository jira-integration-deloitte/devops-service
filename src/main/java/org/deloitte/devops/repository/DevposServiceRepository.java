...
public class DevposServiceRepository implements DevopsRepository, ApplicationConstants {
	...
	public <T, E> T post(String url, Class<T> responseType, E requestBody, String authHeader) {
		...
		ResponseEntity<T> response = template.exchange(url, HttpMethod.POST, entity, responseType,
	...
	public <T> T get(String url, ParameterizedTypeReference<T> type, Map<String, Object> uriVariables,
		...
		ResponseEntity<T> response = template.exchange(url, HttpMethod.GET, entity, type, uriVariables);
	...
	public <T> T post(String url, ParameterizedTypeReference<T> type, Object requestBody, String authHeader) {
		...
		ResponseEntity<T> response = template.exchange(url, HttpMethod.POST, entity, type, Collections.emptyMap());
